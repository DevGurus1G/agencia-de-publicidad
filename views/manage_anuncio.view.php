...
<form action="authenticate" method="post" id="registroAnuncio-form">
  <div class="configAnuncio">
    <?php if (isset($editar)):?>
      ...
      <input type="text" placeholder="Titulo" value="<? $anuncio['titulo'] ?>"  id="tituloAnuncio"/>
